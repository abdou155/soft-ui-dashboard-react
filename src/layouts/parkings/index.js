  ...
  const getCategory = (data) => {
    switch (data) {
      case "EVSE":
        return "EVSE";
      case "PREGNENT":
        return "Pregnent women";
      case "HANDICAP":
        return "Individual with disabilites";
      default:
        return "Traditional spot";
    }
  };
        ...
        status: (
          <>
            <SoftBadge
              ...
              color={el.status == "open" ? "danger" : "secondary"}
              size="xs"
              container
            />
          </>
          ...
          <>
            <SoftBox style={{ display: "flex" }}>
              <SoftBox onClick={() => handleOpen(el)}>
                <Icon
                  sx={{ cursor: "pointer", color: "gray", marginRight: "8px" }}
                  fontSize="small"
                >
                  visibility
                </Icon>
        ...
        status: (
          <>
            <SoftBadge
              variant="gradient"
              badgeContent={el.status}
              color={el.status == "available" ? "success" : "error"}
              size="xs"
              container
            />
          </>
    ...
    <DashboardLayout>
      ...
      >
        <SoftBox sx={style}>
          ...
          <SoftBox sx={{ mt: 2 }} style={{ display: "flex", justifyContent: "end" }}>
            <SoftButton onClick={handleSpotFormClose} color="dark" size="small">
              Back
            </SoftButton>
            <SoftButton onClick={handleSpotFormClose} color="dark" size="small">
              Submit
